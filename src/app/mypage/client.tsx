...
export default function MyPageClient({ user, isAdmin }: MyPageClientProps) {
      ...
      <div className="bg-white mt-2">
        <div className="px-4 py-6">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center overflow-hidden relative">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500">
                가입일: {getKSTDateString(new Date(user.created_at))}
              </p>
            </div>
          </div>
        </div>
